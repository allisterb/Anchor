...
| `DogwoodSemantics.tla` | our reading of Dogwood's temporal operators — `formerly`, `previous`, `since`, and the `count`/`sum` aggregations. Differential-tested against Dogwood's own corpus on 700 pairs. |
