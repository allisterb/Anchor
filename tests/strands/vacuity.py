...
through `dogwood_parse` -- the parser whose reading agrees with the reference implementation on 654
...
\\*
\\* Translated by the parser that agrees with the Dogwood reference implementation on 654 recorded
