\* GENERATED by src/translator/policy_module.py from docs_trading_forbidden.dw -- do not edit.
\*
...
Source == "docs_trading_forbidden.dw"
...
InputDomain  == [stock |-> {[k |-> "n", v |-> 1], [k |-> "n", v |-> 2]}]
...
Policies ==
  <<
    [effect |-> "forbid", actions |-> {"ApproveSale"}, cond |-> [op |-> "true", args |-> <<>>, term |-> [op |-> "formerly", window |-> 0, atom |-> [op |-> "pred", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], left |-> [op |-> "pred", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], leftNeg |-> FALSE, keys |-> <<>>]]],
