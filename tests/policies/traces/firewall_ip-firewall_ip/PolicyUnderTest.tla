\* GENERATED by src/translator/policy_module.py from firewall_ip.dw -- do not edit.
\*
...
Policies ==
  <<
    [effect |-> "forbid", actions |-> {"Connect"}, cond |-> [op |-> "term", args |-> <<>>, term |-> [op |-> "at", window |-> 0, atom |-> [op |-> "inrange", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "src", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<10, 0, 0, 0>>, prefix |-> 8], left |-> [op |-> "inrange", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "src", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<10, 0, 0, 0>>, prefix |-> 8], leftNeg |-> FALSE, keys |-> <<>>]]],
