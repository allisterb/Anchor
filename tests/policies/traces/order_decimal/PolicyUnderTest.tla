\* GENERATED by src/translator/policy_module.py from order_decimal.dw -- do not edit.
\*
...
InputDomain  == [f \in {} |-> {}]
OutputDomain == [score |-> {[k |-> "n", v |-> 1], [k |-> "n", v |-> 2]}]
...
Policies ==
  <<
    [effect |-> "permit", actions |-> {"Trade"}, cond |-> [op |-> "exists", args |-> <<>>, term |-> [op |-> "formerly", window |-> 0, atom |-> [op |-> "pred", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], left |-> [op |-> "pred", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], leftNeg |-> FALSE, keys |-> <<>>], agg |-> [kind |-> "exists", over |-> "", binders |-> <<[name |-> "s", type |-> "Long"]>>, cond |-> [op |-> "and", args |-> <<[op |-> "term", args |-> <<>>, term |-> [op |-> "formerly", window |-> 3600, atom |-> [op |-> "pred", pred |-> [action |-> "Score", kind |-> "response", binds |-> <<[side |-> "output", field |-> "score", kind |-> "var", name |-> "s", value |-> [k |-> "s", v |-> ""]]>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], left |-> [op |-> "pred", pred |-> [action |-> "Score", kind |-> "response", binds |-> <<[side |-> "output", field |-> "score", kind |-> "var", name |-> "s", value |-> [k |-> "s", v |-> ""]]>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], leftNeg |-> FALSE, keys |-> <<>>]], [op |-> "term", args |-> <<>>, term |-> [op |-> "at", window |-> 0, atom |-> [op |-> "cmpvar", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "s", args |-> <<>>, field |-> "", cmp |-> ">", value |-> [k |-> "d", v |-> 5000], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], left |-> [op |-> "cmpvar", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "s", args |-> <<>>, field |-> "", cmp |-> ">", value |-> [k |-> "d", v |-> 5000], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], leftNeg |-> FALSE, keys |-> <<>>]]>>, term |-> [op |-> "formerly", window |-> 0, atom |-> [op |-> "pred", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], left |-> [op |-> "pred", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], leftNeg |-> FALSE, keys |-> <<>>]]], cmp |-> "", value |-> 0]]
  >>
