\* GENERATED by src/translator/policy_module.py from order_long.dw -- do not edit.
\*
...
InputDomain  == [f \in {} |-> {}]
OutputDomain == [count |-> {[k |-> "n", v |-> 1], [k |-> "n", v |-> 2]}]
...
Policies ==
  <<
    [effect |-> "permit", actions |-> {"Trade"}, cond |-> [op |-> "exists", args |-> <<>>, term |-> [op |-> "formerly", window |-> 0, atom |-> [op |-> "pred", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], left |-> [op |-> "pred", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], leftNeg |-> FALSE, keys |-> <<>>], agg |-> [kind |-> "exists", over |-> "", binders |-> <<[name |-> "s", type |-> "Long"]>>, cond |-> [op |-> "and", args |-> <<[op |-> "term", args |-> <<>>, term |-> [op |-> "formerly", window |-> 3600, atom |-> [op |-> "pred", pred |-> [action |-> "Score", kind |-> "response", binds |-> <<[side |-> "output", field |-> "count", kind |-> "var", name |-> "s", value |-> [k |-> "s", v |-> ""]]>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], left |-> [op |-> "pred", pred |-> [action |-> "Score", kind |-> "response", binds |-> <<[side |-> "output", field |-> "count", kind |-> "var", name |-> "s", value |-> [k |-> "s", v |-> ""]]>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], leftNeg |-> FALSE, keys |-> <<>>]], [op |-> "term", args |-> <<>>, term |-> [op |-> "at", window |-> 0, atom |-> [op |-> "cmpvar", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "s", args |-> <<>>, field |-> "", cmp |-> ">", value |-> [k |-> "n", v |-> 0], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], left |-> [op |-> "cmpvar", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "s", args |-> <<>>, field |-> "", cmp |-> ">", value |-> [k |-> "n", v |-> 0], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], leftNeg |-> FALSE, keys |-> <<>>]]>>, term |-> [op |-> "formerly", window |-> 0, atom |-> [op |-> "pred", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], left |-> [op |-> "pred", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], leftNeg |-> FALSE, keys |-> <<>>]]], cmp |-> "", value |-> 0]]
  >>
