\* GENERATED by src/translator/policy_module.py from firewall_ip_narrow.dw -- do not edit.
\*
...
InputDomain  == [src |-> {[k |-> "a", v |-> <<10, 0, 0, 0>>], [k |-> "a", v |-> <<11, 0, 0, 0>>]}]
OutputDomain == [f \in {} |-> {}]
AllValues    == {[k |-> "a", v |-> <<10, 0, 0, 0>>], [k |-> "a", v |-> <<11, 0, 0, 0>>]}
...
Policies ==
  <<
    [effect |-> "forbid", actions |-> {"Connect"}, cond |-> [op |-> "term", args |-> <<>>, term |-> [op |-> "at", window |-> 0, atom |-> [op |-> "inrange", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "src", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<10, 0, 0, 0>>, prefix |-> 9], left |-> [op |-> "inrange", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "src", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<10, 0, 0, 0>>, prefix |-> 9], leftNeg |-> FALSE, keys |-> <<>>]]],
    [effect |-> "permit", actions |-> {"Connect"}, cond |-> [op |-> "true", args |-> <<>>, term |-> [op |-> "formerly", window |-> 0, atom |-> [op |-> "pred", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], left |-> [op |-> "pred", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], leftNeg |-> FALSE, keys |-> <<>>]]]
  >>
