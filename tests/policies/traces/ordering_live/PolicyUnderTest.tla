\* GENERATED by src/translator/policy_module.py from ordering_live.dw -- do not edit.
\*
...
InputDomain  == [cost |-> {[k |-> "n", v |-> 24999], [k |-> "n", v |-> 25000], [k |-> "n", v |-> 25001]}]
OutputDomain == [f \in {} |-> {}]
AllValues    == {[k |-> "n", v |-> 24999], [k |-> "n", v |-> 25000], [k |-> "n", v |-> 25001]}
