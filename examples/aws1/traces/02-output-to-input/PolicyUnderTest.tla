\* GENERATED by src/translator/policy_module.py from 02-output-to-input.dw -- do not edit.
\*
...
Actions      == {"execute_trade", "get_client_profile"}
