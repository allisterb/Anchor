\* GENERATED by src/translator/policy_module.py from 04-cumulative-budget-cap.dw -- do not edit.
\*
...
Source == "04-cumulative-budget-cap.dw"
...
Actions      == {"execute_trade", "get_market_price"}
Kinds        == {"request"}
InputFields  == {"cost"}
OutputFields == {}
...
InputDomain  == [cost |-> {[k |-> "n", v |-> 1], [k |-> "n", v |-> 2]}]
OutputDomain == [f \in {} |-> {}]
...
Policies ==
  <<
    [effect |-> "permit", actions |-> {"execute_trade"}, cond |-> [op |-> "agg", args |-> <<>>, term |-> [op |-> "formerly", window |-> 0, atom |-> [op |-> "pred", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], left |-> [op |-> "pred", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], leftNeg |-> FALSE, keys |-> <<>>], agg |-> [kind |-> "sum", over |-> "amount", binders |-> <<[name |-> "amount", type |-> "Long"], [name |-> "t", type |-> "Timepoint"]>>, cond |-> [op |-> "term", args |-> <<>>, term |-> [op |-> "formerly", window |-> 86400, atom |-> [op |-> "and", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<[op |-> "pred", pred |-> [action |-> "get_market_price", kind |-> "request", binds |-> <<[side |-> "input", field |-> "cost", kind |-> "var", name |-> "amount", value |-> [k |-> "s", v |-> ""]]>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], [op |-> "tp", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "t", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0]>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], left |-> [op |-> "and", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "", args |-> <<[op |-> "pred", pred |-> [action |-> "get_market_price", kind |-> "request", binds |-> <<[side |-> "input", field |-> "cost", kind |-> "var", name |-> "amount", value |-> [k |-> "s", v |-> ""]]>>], var |-> "", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], [op |-> "tp", pred |-> [action |-> "", kind |-> "", binds |-> <<>>], var |-> "t", args |-> <<>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0]>>, field |-> "", cmp |-> "", value |-> [k |-> "s", v |-> ""], other |-> "", pattern |-> <<>>, net |-> <<>>, prefix |-> 0], leftNeg |-> FALSE, keys |-> <<>>]]], cmp |-> "<", value |-> 60000]]
  >>
