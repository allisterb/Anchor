...
```bash
python/Scripts/uv.exe pip compile requirements/strands/requirements.in --universal --python-version 3.13 --generate-hashes -o requirements/strands/requirements.txt
```
...
```bash
./requirements/strands/install.sh
```
